...
export const BuildingStats: Record<BuildingType, { size: number; maxHealth: number; color: string; range?: number; attack?: number; attackCooldown?: number }> = {
    ...
    [BuildingType.House]: { size: 32, maxHealth: 300, color: '#ea580c' }, // Orange 600
    [BuildingType.Tower]: { size: 32, maxHealth: 800, color: '#525252', range: 200, attack: 10, attackCooldown: 1.0 }, // Neutral Gray
